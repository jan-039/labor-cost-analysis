...
* `To What Extent Is The American Dream Still Attainable.pdf` — Original group datathon presentation that won **Best Visuals**. The datathon was hosted by the Association for Information Systems from California State University, Long Beach. My contribution focused on the wage-growth analysis shown on **Slide 3**, which examined how earning opportunities varied across industries.
